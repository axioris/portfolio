  ...
  return (
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
          bringing blockchain to life with seamless experiences that inspire growth.
        </motion.p>
      </div>

      {/* IMAGE */}
      <div data-blobity-tooltip="Dane Foster">
        <motion.div
          ref={imgRef}
          style={{ rotate }}
        ...
        >
          <Image
            ...
            fill
            alt="Dane's picture"
            className="bg-icon-radial px-5 pt-10"
          />
        </motion.div>
      </div>
    </section>
